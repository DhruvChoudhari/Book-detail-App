...
// Load a single book on detail page used in 'BookDetailsScreen' only to show book on header on detail page
// book and scrollY are taken as parameter since for every book its photo and its design etc will be different
// and we are not fetching book data here therefore we are using book as variable
